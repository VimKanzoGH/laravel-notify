...
<body class="h-screen text-gray-500 transition duration-100 ease-in-out bg-gray-50 font-body">
    ...
    <footer class="max-w-screen-xl px-4 py-5 mx-auto sm:px-6 lg:px-8">
        <div class="flex items-center space-x-2 text-gray-500">
            <p>&copy; {{ date('Y') }} - <a href="https://github.com/mckenziearts/laravel-notify" class="font-medium" target="_blank">Laravel <span class="font-semibold text-pink-600">Notify</span></a> v2.0</p>
